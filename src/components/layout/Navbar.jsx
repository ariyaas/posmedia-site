...
//             <img
//               src="/logo/poslogo.svg"
//               alt="POS Media Logo"
//              className="h-[60px] sm:h-[66px] lg:h-[80px] w-auto"
//             />

//             <img
//               src="/logo/badge.png"
//               alt="20 Years Experience"
// className="hidden xl:block h-[50px] xl:h-[70px] w-auto"            />
//           </div>
...
//       <img src="/logo/poslogo.svg" alt="logo" className="h-12" />
...
<nav className="sticky top-[27px] sm:top-[35px] w-full z-30 bg-white border-b border-gray-200 py-1 xl:py-1.5  font-body relative">     <div className="w-full px-[5%] flex items-center justify-between">          {/* LOGO + BADGE (FINAL OPTIMIZED IMAGES) */}
         <div className="flex items-center gap-6 justify-start">
            ...
            <img
              src="/logo/badge.png"
              alt="20 Years Experience"
className="hidden xl:block h-[45px] xl:h-[65px] w-auto"            />
          </div>
